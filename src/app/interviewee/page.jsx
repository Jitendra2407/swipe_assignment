...
export default function IntervieweePage() {
  ...
  // *** FIX IS HERE: Add a ref to track if the initial check is done ***
  ...
  // This effect now only runs the check ONCE after the page loads
  useEffect(() => {
    if (
      isClient &&
    ...
    // Mark the check as performed so it doesn't run again
    if (isClient) {
